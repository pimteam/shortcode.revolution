...
class ShortcodeRevolutionFlashcards extends ShortcodeRevolutionShortcode {	
	...
	public static function card($atts, $contents = '') {
		...
		$flashcard = '';	
		$flashcard .= "<div class='srevo-flashcard' style='cursor:pointer; width:" . $width . ";height:" . $height . ";border-radius:" . $border_radius . ";' onclick=\"jQuery(this).flip('toggle');\"><div class='srevo-flashcard-front front' style='padding: ".$padding.";background-color:" . $color . ";border-radius:" . $border_radius . ";'>" . $front_side . "</div><div class='srevo-flashcard-back back' style='padding: ".$padding.";background-color:" . $back_color . ";border-radius:" . $border_radius. ";'>" . $back_side . "</div></div>";		
